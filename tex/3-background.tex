...
(900 MHz in the U.S.) and bandwidths of 125-500kHz. \cmt{LoRaWAN clients can
transmit at low-data rates (few kbps) to gateways up to 10 km away in free
space and last up to 10-years on AA batteries}{seems redundant}. Below, we
...
extensively planned and have dedicated optic fiber connections). \cmt{The goal of
this paper is to make individual unreliable user-deployed gateways more reliable by pooling
together PHY-layer processing at the cloud.}{I don't think that's the goal. the goal is to improve coverag and battery life of clients... need a better end to the paragraph}
