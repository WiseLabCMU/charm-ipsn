...
This paper presents Charm, a system that enhances \cmt{the battery-life and
coverage of LP-WAN clients}{reword this... clients dont have coverage, the network does} in large urban deployments. Charm
...
available LP-WAN technology. \cmt{Charm is implemented in a first-of-its-kind
low-power wide-area pilot deployment for coherent diversity combining. This
deployment serves a large neighborhood of a major U.S. city and demonstrates
increased coverage and battery-life across clients in the network.}{clarify
using 2 testbeds}
...
system for low-power WANs offers radically new challenges. \cmt{At the
gateways, LP-WAN signals are often too weak to be ordinarily detected -- more
...
below. \cmt{}{Clarify novelty of our approach... no need to time-sync, noise resilience, using data part of packet, mid-way hardware between dedicated radio and SDR}
