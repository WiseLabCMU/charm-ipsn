...
detect for an individual gateway, but they are also difficult to detect on the
air. Since transmitted signals would combine coherently, as opposed to random
noise which adds up non-coherently, the appropriate combination of radio
streams from different gateways might be able to decode such a message.
