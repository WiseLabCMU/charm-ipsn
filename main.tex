...
\newcommand{\cmt}[2]{{\color{blue} } {\color{red} [#2] }}
\newcommand{\revathy}[1]{\textcolor{green}{{\bf }}}
%\newcommand{\revathy}[1]{\textcolor{green}{{\bf #2}}}
\newcommand{\akshay}[1]{\textcolor{violet}{#1}}
...
\email{ [adongare, revathyn, agadre, aluong2, arturb, swarunk, agr, roberti] @andrew.cmu.edu}
