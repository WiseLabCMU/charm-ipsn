...
gateways expected in cities. Devices located deep within buildings or in
remote neighborhoods will suffer severe battery drain due to the extended
transmissions at the slowest data-rate necessary to reach even the closest
gateway.
...
present a scaleable solution to decoding weak transmissions at city-scale by
